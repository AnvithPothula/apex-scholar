...
// Official curriculum information for all AP subjects extracted from AP Course and Exam Descriptions

export const AP_CURRICULUM_COMPREHENSIVE = {
  "artHistory": {
    name: "AP Art History",
    ...
    units: [
      ...
      },
      {
        ...
        topics: [
          ...
          "Yaxchilan, Structure 23 and its lintels",
          "Templo Mayor (Main Temple)",
          "Ruler's feather headdress",
          "City of Cusco, including Qorikancha and Sacsayhuaman",
          "Maize cobs",
          "Effigy mound",
      ...
      },
      {
        ...
        weight: "8-10%",
        topics: [
          "Persepolis: apadana of Darius and Xerxes and hall of 100 columns",
          "The David Vases",
          "Ardabil Carpet",
          "The Kaaba",
          "Dome of the Rock",
          ...
          "Mosque lamp from the mausoleum of Sayf al-Din Tuquztimur"
        ],
        keyConcepts: [
      ...
      },
      {
        ...
        topics: [
          ...
          "Self-Portrait",
          "The Qianlong Emperor's Southern Inspection Tour, Scroll Seven"
        ],
        keyConcepts: [
  ...
  "europeanHistory": {
    ...
    description: "Study the cultural, economic, political, and social developments that have shaped Europe from c. 1450 to the present.",
    examFormat: {
      duration: "3 hours 15 minutes",
      sections: [
    ...
    bigIdeas: [
      "Interaction of Europe and the World: As European society became more complex and economically sophisticated, Europeans developed new techniques for expanding their political and economic power throughout the continent and the world",
      "Poverty and Prosperity: Europeans' efforts to address the tension between traditional values and commercial pursuits led to important social, political, and cultural transformations",
      "Objective Knowledge and Subjective Visions: The emergence of modern European society brought new ideas about religion, politics, society, and human nature",
      "States and Other Institutions of Power: European states and political institutions took a variety of forms and introduced a variety of innovations, resulting in various forms of resistance and accommodation",
      "Individual and Society: Europeans gradually developed and periodically reevaluated an understanding of the individual's place in society and of the individual's responsibility to society"
    ],
    units: [
      {
        ...
        keyConcepts: [
          ...
          "Commercial revolution and banking",
          "Protestant Reformation causes",
          "Scientific Revolution beginnings"
        ],
        essentialKnowledge: [
          "Renaissance ideals emphasized human potential and achievement",
          "European exploration led to global exchange networks",
          "Commercial practices revolutionized European economy",
          "Religious and political conflicts shaped the period",
          "New ideas challenged traditional authority"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Religious wars and political consequences",
          "Peace of Westphalia and sovereignty",
          "Impact on European society and culture",
          "Religious tolerance and intolerance"
        ],
        essentialKnowledge: [
          "Protestant Reformation challenged Catholic Church authority",
          "Catholic Reformation renewed and reformed the Church",
          "Religious conflicts had political and social consequences",
          "The Peace of Westphalia established new diplomatic principles",
          "Religious divisions permanently altered European Christianity"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Enlightenment ideas and rational thought",
          "Enlightened despotism",
          "Balance of power in European diplomacy",
          "Social contract theory"
        ],
        essentialKnowledge: [
          "Absolute monarchs concentrated power in royal hands",
          "Constitutional systems limited royal authority",
          "Enlightenment thinkers championed reason and natural rights",
          "New ideas influenced political and social reform",
          "European powers competed for dominance"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Salon culture and public sphere",
          "Population growth and agricultural changes",
          "Social hierarchy and mobility",
          "Gender roles and family structure"
        ],
        essentialKnowledge: [
          "Scientific Revolution established new methods of inquiry",
          "Enlightenment ideas spread through new social institutions",
          "Society remained hierarchical but experienced some mobility",
          "Agricultural improvements supported population growth",
          "New ideas about gender and family emerged"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Napoleonic reforms and conquests",
          "Conservative reaction and restoration",
          "Nationalism and liberalism",
          "Concert of Europe"
        ],
        essentialKnowledge: [
          "French Revolution transformed European politics and society",
          "Napoleon spread revolutionary and nationalist ideas",
          "Congress of Vienna sought to restore stability",
          "Revolutionary ideals continued to influence Europe",
          "Balance of power was reestablished but remained fragile"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Working class conditions and responses",
          "Middle class emergence",
          "Government responses to industrialization"
        ],
        essentialKnowledge: [
          "Industrial Revolution transformed economic and social structures",
          "New social classes emerged with distinct interests",
          "Workers organized to improve conditions",
          "Governments gradually increased economic regulation",
          "Standard of living debates continue among historians"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Socialism and working class movements",
          "Conservatism and traditional values",
          "Imperialism and global expansion",
          "Balance of power and alliance systems"
        ],
        essentialKnowledge: [
          "Competing ideologies shaped 19th-century politics",
          "Nation-states replaced multinational empires",
          "European powers carved up Africa and Asia",
          "Alliance systems created international tensions",
          "Democracy gradually expanded in many countries"
        ]
      },
      {
        ...
        essentialKnowledge: [
          "World War I devastated Europe and ended empires",
          "Economic and political crises followed the war",
          "Totalitarian regimes arose in several countries",
          "World War II was more destructive than the first",
          "European dominance in world affairs ended"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Decolonization and end of empires",
          "Social and cultural changes",
          "Economic reconstruction and growth",
          "End of Cold War and new challenges"
        ],
        essentialKnowledge: [
          "Europe was divided by the Cold War",
          "European integration created new political structures",
          "Social movements transformed European society",
          "Economic cooperation promoted prosperity",
          "Contemporary Europe faces new global challenges"
        ]
      }
    ],
    keySkills: [
      "Developments and Processes: Identify and explain a historically significant development or process",
      ...
      "Contextualization: Analyze the context of historical developments and processes",
      "Making Connections: Using historical reasoning processes, analyze patterns and connections",
      "Argumentation: Develop an argument through evaluating historical interpretations and evidence"
    ],
    studyTips: [
      "Focus on major themes and patterns across time periods",
      "Practice document analysis and source evaluation skills",
      "Understand cause and effect relationships in European history",
      "Learn key dates and chronology for contextualization",
      "Practice writing thesis statements and constructing arguments",
      "Study maps to understand geographic influences",
      "Connect European developments to global contexts",
      "Practice with past AP exam questions and rubrics",
      "Create timelines linking political, social, and economic changes",
      "Understand historiographic debates and interpretations"
    ],
    commonTopics: [
      "Renaissance humanism and artistic achievements",
      "Protestant Reformation and religious wars",
      "Absolutism vs. constitutionalism debates",
      "Scientific Revolution and Enlightenment ideas",
      "French Revolution causes, phases, and consequences",
      "Napoleonic era and its impact on Europe",
      "Industrial Revolution and social changes",
      "Nationalism and 19th-century state formation",
      "New Imperialism and European expansion",
      "World Wars and their devastating consequences",
      "Cold War division and European integration",
      "Contemporary European challenges and opportunities"
    ]
  },
  ...
  "macroeconomics": {
    ...
    description: "Study the principles of economics that apply to an economic system as a whole, including economic growth, inflation, unemployment, and fiscal and monetary policy.",
    examFormat: {
      duration: "2 hours 10 minutes",
      sections: [
        { name: "Multiple Choice", questions: 60, time: "70 minutes", weight: "66%" },
        { name: "Free Response", questions: 3, time: "60 minutes", weight: "33%" }
      ]
    },
    bigIdeas: [
      "Economic Measurements: How do economists measure the macroeconomy?",
      "Economic Interactions: How do economic actors interact in markets?",
      "Economic Fluctuations: Why does economic output fluctuate?",
      "Economic Policy: How can policy be used to influence the economy?"
    ],
    units: [
      {
        ...
        essentialKnowledge: [
          ...
          "PPF illustrates scarcity, opportunity cost, and efficiency",
          "Specialization based on comparative advantage increases output",
          "Different economic systems organize production differently"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Real vs. nominal GDP and values",
        ...
        essentialKnowledge: [
          ...
          "Different types of unemployment have different causes",
          "Inflation is measured by changes in price indices",
          "Real values adjust for inflation effects",
      ...
      },
      {
        ...
        essentialKnowledge: [
          "Aggregate demand shows the relationship between price level and real GDP",
          "Multipliers amplify the effects of spending changes",
          "Aggregate supply differs in the short run and long run",
      ...
      },
      {
        ...
        keyConcepts: [
          ...
          "Federal Reserve tools: reserve requirements, discount rate, open market operations",
          "Loanable funds market and real interest rate",
          "Monetary policy transmission mechanism"
        ],
        essentialKnowledge: [
          "Money serves multiple functions in an economy",
      ...
      },
      {
        ...
        keyConcepts: [
          ...
          "Sources of economic growth: labor, capital, technology",
          "Supply-side policies",
          "Sustainability of fiscal policy"
        ],
        essentialKnowledge: [
          "Fiscal policy uses government spending and taxation",
          "Automatic stabilizers respond to economic conditions",
          "Crowding out occurs when government borrowing raises interest rates",
          "Economic growth requires increases in productive capacity",
          "Long-term fiscal sustainability is important for economic stability"
        ]
      },
      {
        ...
        essentialKnowledge: [
          ...
          "Open economy policies have international consequences"
        ]
      }
    ],
    keySkills: [
      "Definition: Define economic terms and concepts clearly",
      "Explanation: Explain economic concepts, relationships, and processes",
      "Illustration: Illustrate economic concepts using graphs and diagrams",
      "Calculation: Perform calculations to solve economic problems",
      "Manipulation: Manipulate economic models to show changes",
      "Graphical Analysis: Create, interpret, and manipulate graphs"
    ],
    studyTips: [
      "Master graphical analysis - draw and interpret economic graphs regularly",
      "Understand the relationships between economic variables",
      "Practice calculating multipliers, unemployment rates, and inflation",
      "Learn to distinguish between short-run and long-run effects",
      "Study current economic events and policy debates",
      "Memorize key formulas and economic definitions",
      "Practice explaining economic reasoning step-by-step",
      "Understand the transmission mechanisms of policies",
      "Connect microeconomic concepts to macroeconomic outcomes",
      "Focus on cause-and-effect relationships in economics"
    ],
    commonTopics: [
      "GDP calculation and limitations",
      "Types of unemployment and natural rate",
      "Inflation measurement and costs",
      "Aggregate demand and supply analysis",
      "Multiplier effects of spending and taxes",
  ...
  "microeconomics": {
    ...
    description: "Study the principles of economics that apply to the functions of individual decision makers, both consumers and producers, within the economic system.",
    examFormat: {
      duration: "2 hours 10 minutes",
      sections: [
        { name: "Multiple Choice", questions: 60, time: "70 minutes", weight: "66%" },
    ...
    bigIdeas: [
      "Scarcity: How do people make decisions in a world of scarcity?",
      "Markets: How do markets function and when do they fail?",
      "Market Failures and Role of Government: When is government intervention justified in a market economy?",
      "Production Decisions: How do firms make production decisions?"
    ],
    units: [
      {
        name: "Unit 1: Basic Economic Concepts",
        ...
        essentialKnowledge: [
          ...
          "PPF illustrates scarcity, efficiency, and economic growth",
          "Comparative advantage determines trade patterns",
          "Supply and demand determine market prices",
          "Markets allocate resources efficiently under certain conditions"
        ]
      },
      {
        ...
        essentialKnowledge: [
          ...
          "Elasticity determines the burden of taxes",
          "Consumers maximize utility subject to budget constraints",
          "Income and substitution effects explain demand curve slopes",
          "Different goods have different elasticity characteristics"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Marginal cost, average cost, and cost curves",
        ...
        essentialKnowledge: [
          "Production exhibits diminishing marginal returns in short run",
          "Cost curves have predictable shapes due to returns to scale",
          "Firms maximize profit by setting MR = MC",
          "Perfect competition leads to efficient outcomes",
          "Long-run equilibrium eliminates economic profits"
        ]
      },
      {
        ...
        essentialKnowledge: [
          ...
          "Monopolies create deadweight loss but may have benefits",
          "Price discrimination can increase profits and efficiency",
          "Monopolistic competition combines competition with differentiation",
          "Oligopolies involve strategic interdependence"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Factor supply curves and economic rent",
        ...
        essentialKnowledge: [
          ...
          "Firms hire factors until MRP equals factor price",
          "Factor prices depend on supply and demand conditions",
          "Monopsony power can depress factor prices",
          "Different factors have different supply characteristics"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Free rider problem",
          "Government solutions: taxes, subsidies, regulation",
          "Price controls: price floors and ceilings"
        ],
        essentialKnowledge: [
          "Markets fail when they don't achieve allocative efficiency",
          "Externalities cause market outcomes to be inefficient",
          "Public goods are under-provided by markets",
          "Government intervention can correct market failures",
          "Policy tools have different effects and trade-offs"
        ]
      }
    ],
    keySkills: [
      "Definition: Define economic terms and concepts clearly",
      "Explanation: Explain economic concepts and relationships",
      "Illustration: Use graphs to illustrate economic concepts",
      "Calculation: Perform calculations to solve economic problems",
      "Manipulation: Show changes in economic models graphically",
      "Analysis: Analyze economic scenarios and policy effects"
    ],
    studyTips: [
      "Master supply and demand graphs - they appear in every unit",
      "Understand elasticity calculations and interpretations",
      "Practice drawing and analyzing cost curves",
      "Learn the profit maximization rule MR = MC thoroughly",
      "Compare and contrast different market structures",
      "Understand the connection between product and factor markets",
      "Study real-world examples of market failures",
      "Practice graphing consumer and producer surplus",
      "Memorize characteristics of different market structures",
      "Focus on efficiency concepts and welfare analysis"
    ],
    commonTopics: [
      "Supply and demand analysis and shifts",
  ...
  "usGovernmentPolitics": {
    ...
    description: "Study the operations of the American political system, examining the Constitution, political behavior, political parties, interest groups, and policy making at the national level.",
    examFormat: {
      duration: "3 hours",
      sections: [
        { name: "Multiple Choice", questions: 55, time: "80 minutes", weight: "50%" },
        { name: "Free Response", questions: 4, time: "100 minutes", weight: "50%" }
      ]
    },
    bigIdeas: [
      "Constitutionalism: How and why do states arise, and how are they sustained?",
      "Liberty and Order: How do societies balance individual liberty with the need for order?",
      "Civic Participation in a Representative Democracy: What does it mean to be a citizen in a representative democracy?",
      "Competing Policy-Making Interests: How do different interests compete for influence over policy making?",
      "Methods of Political Analysis: How do political scientists measure and explain political behaviors and outcomes?"
    ],
    units: [
      {
        ...
        essentialKnowledge: [
          "Democratic government balances competing values",
          "Constitution created stronger federal government",
          "Federalism divides power between levels of government",
      ...
      },
      {
        ...
        keyConcepts: [
          ...
          "Presidential roles: chief executive, commander in chief",
          "Executive powers and presidential influence",
          "Bureaucratic structure and implementation",
        ...
        essentialKnowledge: [
          ...
          "Congress makes laws but faces collective action problems",
          "President has grown in power over time",
          "Bureaucracy implements and enforces laws",
          "Courts interpret laws and Constitution"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Fourth through Eighth Amendment protections",
        ...
        essentialKnowledge: [
          ...
          "First Amendment freedoms have limits",
          "Equal protection requires similar treatment",
          "Civil rights movements expand equality",
      ...
      },
      {
        ...
        keyConcepts: [
          ...
          "Polling methods and limitations",
          "Political socialization agents",
          "Demographic influences on beliefs",
          "Ideology and policy preferences"
        ],
        essentialKnowledge: [
          "American political culture shapes beliefs",
          "Ideologies provide frameworks for understanding politics",
          "Public opinion influences and constrains government",
          "Polling has limitations and potential bias",
          "Political beliefs develop through socialization"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Interest group strategies and influence",
          "Social movements and political change"
        ],
        essentialKnowledge: [
          "Voting rights have expanded but barriers remain",
          "Multiple factors influence voting behavior",
          "Political parties organize elections and government",
          "Campaigns require significant resources",
          "Interest groups provide representation beyond parties"
        ]
      }
    ],
    keySkills: [
      "Constitutional Analysis: Analyze and interpret constitutional principles",
      "Political Institution Analysis: Explain how political institutions operate",
      "Policy Analysis: Analyze policy-making processes and outcomes",
      "Data Analysis: Interpret political data and polling information",
      "Argumentation: Develop arguments about political issues with evidence",
      "Comparison: Compare political concepts, behaviors, and institutions"
    ],
    studyTips: [
      "Master the Constitution and its key principles",
      "Learn major Supreme Court cases and their significance",
      "Understand how the three branches interact and check each other",
      "Study the evolution of civil liberties and civil rights",
      "Practice analyzing political data and poll results",
      "Learn the structure and functions of political institutions",
      "Understand the role of political parties and interest groups",
      "Practice writing clear, evidence-based arguments",
      "Study current political events through course concepts",
      "Use primary sources like founding documents"
    ],
    commonTopics: [
      "Constitutional principles and founding documents",
      "Separation of powers and checks and balances",
      "Congressional powers and legislative process",
      "Presidential powers and roles",
      "Federal bureaucracy structure and function",
      "Supreme Court cases on civil liberties and rights",
  ...
  "worldHistory": {
    ...
    description: "Study the cultural, economic, political, and social developments that have shaped the world from c. 1200 CE to the present, with special focus on global processes and interactions.",
    examFormat: {
      duration: "3 hours 15 minutes",
      sections: [
        { name: "Multiple Choice", questions: 55, time: "55 minutes", weight: "40%" },
    ...
    bigIdeas: [
      "Humans and the Environment: How have people shaped the world and how has the world shaped human societies?",
      "Cultural Developments and Interactions: How have cultures developed and interacted throughout history?",
      "Governance: How have different forms of governance developed and changed over time?",
      "Economic Systems: How have economic systems developed and changed over time?",
      "Social Interactions and Organization: How have social categories, roles, and practices changed over time?",
      "Technology and Innovation: How have technology and innovation shaped human societies?"
    ],
    units: [
      {
        ...
        keyConcepts: [
          ...
          "Trans-Saharan trade and Mali Empire",
          "Byzantine Empire and Western European feudalism",
          "Mongol Empire and its impact"
        ],
        essentialKnowledge: [
          "Complex societies developed across multiple continents",
          "Trade networks connected distant regions",
          "Religious and cultural traditions shaped societies",
          "Political structures varied but shared common features",
          "Technological innovations spread through trade"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Growth of trading cities: Malacca, Venice, Timbuktu",
          "Spread of Islam through trade",
          "Technology transfer: compass, gunpowder, printing",
          "Spread of crops and diseases",
          "Economic specialization and commercial practices"
        ],
        essentialKnowledge: [
          "Trade networks facilitated exchange of goods, ideas, and diseases",
          "Maritime technology enabled long-distance ocean trade",
          "Commercial practices developed to support trade",
          "Cultural and religious syncretism occurred along trade routes",
          "Trade contributed to the growth of cities and states"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Tributary systems and tax farming",
          "Devshirme system and Janissaries",
          "Religious legitimacy and divine right",
          "Bureaucratic traditions: civil service exams",
          "Gunpowder empires and military technology"
        ],
        essentialKnowledge: [
          "Gunpowder weapons enabled empire building",
          "Empires used various methods to legitimize rule",
          "Administrative systems helped manage large territories",
          "Religious and ethnic diversity created challenges",
          "Economic policies supported imperial expansion"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Conquistadors and colonial conquest",
          "Biological exchange: crops, animals, diseases",
          "Atlantic slave trade and plantation system",
          "Joint-stock companies: Dutch and English",
          "Mercantilism and global trade",
          "Resistance to European expansion"
        ],
        essentialKnowledge: [
          "Maritime technology enabled global connections",
          "European expansion transformed the Americas",
          "Columbian Exchange had profound global impacts",
          "New labor systems emerged to support colonial economies",
          "Global trade networks integrated world regions"
        ]
      },
      {
        ...
        essentialKnowledge: [
          ...
          "Political revolutions created new forms of government",
          "Industrial Revolution transformed production and society",
          "Nationalism reshaped political boundaries",
          "Reform movements addressed social problems"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "British Raj and company rule",
          "Opium Wars and unequal treaties",
          "Indigenous resistance: Zulu, Cherokee, Aboriginal",
          "Labor migration: indentured servitude, coolies",
          "Urbanization and class formation",
          "New leisure activities and consumer culture"
        ],
        essentialKnowledge: [
          "Industrial power enabled new forms of imperialism",
          "Imperial expansion met various forms of resistance",
          "Global migration patterns changed dramatically",
          "Industrial society created new social structures",
          "Cultural exchange increased through improved communication"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Great Depression and government responses",
          "Rise of fascism and totalitarian states",
          "World War II: causes, conduct, consequences",
          "Holocaust and other genocides",
          "Decolonization movements",
          "Cold War competition and proxy wars",
          "Nuclear weapons and deterrence"
        ],
        essentialKnowledge: [
          "Total wars required unprecedented mobilization",
          "Economic crisis led to new government roles",
          "Ideological conflicts shaped the 20th century",
          "Decolonization reshaped the global political order",
          "Cold War competition influenced global development"
        ]
      },
      {
        ...
        essentialKnowledge: [
          "Cold War created bipolar global order",
          "Decolonization created many new nations",
          "New nations faced political and economic challenges",
          "Non-alignment offered alternative to Cold War blocs",
          "Regional conflicts reflected global tensions"
        ]
      },
      {
        ...
        essentialKnowledge: [
          ...
          "Economic liberalization increased global trade",
          "Cultural exchange intensified through globalization",
          "Global challenges required international cooperation",
          "Globalization created both opportunities and problems"
        ]
      }
    ],
    keySkills: [
      ...
      "Sourcing and Situation: Analyze sourcing and situation of primary and secondary sources",
      "Claims and Evidence: Analyze arguments in secondary sources",
      "Contextualization: Analyze the context of historical events and processes",
      "Making Connections: Explain how historical events relate to broader patterns",
      "Argumentation: Develop arguments using historical reasoning and evidence"
    ],
    studyTips: [
      "Focus on global patterns and connections rather than isolated events",
      "Practice comparing developments across different regions and time periods",
      "Master the SPICE themes: Social, Political, Interaction, Cultural, Economic",
      "Learn to analyze primary sources for point of view and purpose",
      "Practice writing clear thesis statements and using specific evidence",
      "Study maps to understand geographic relationships",
      "Focus on continuities and changes over time",
      "Practice document-based question (DBQ) format regularly",
      "Connect local developments to global processes",
      "Study cause-and-effect relationships across regions"
    ],
    commonTopics: [
      "Trade networks and their effects on societies",
      "Spread of religions and belief systems",
      "Imperial expansion and administration strategies",
      "Impact of technological innovations",
      "Labor systems and their social consequences",
      "Resistance movements and their methods",
      ...
      "Industrialization and its global spread",
      "Decolonization processes and challenges",
      "Globalization and its effects on cultures",
      "Human rights movements and achievements"
    ]
  },

  "studioArt": {
    name: "AP Studio Art and Design",
    description: "Engage in studio art making through inquiry-guided investigation of materials, processes, and ideas. Students create a portfolio that demonstrates inquiry through art making, problem-solving, and self-reflection.",
    examFormat: {
      duration: "Portfolio Submission",
      sections: [
        { name: "Sustained Investigation", weight: "60%", description: "15 digital images showing sustained investigation through practice, experimentation, and revision" },
        { name: "Selected Works", weight: "40%", description: "5 physical artworks or high-quality digital images demonstrating technical skill and understanding" }
      ]
    },
    bigIdeas: [
      "Inquiry and Investigation: How do artists develop meaningful questions that guide their art making?",
      "Making Through Practice, Experimentation, and Revision: How do artists make art?",
      "Communication: How do artists learn about and communicate ideas through their artwork?"
    ],
    concentrations: [
      {
        name: "2-D Art and Design",
        description: "Students work in drawing, painting, printmaking, collage, fabric design, weaving, fashion design, fashion illustration, graphic design, digital imaging, photography, film/video, or mixed media",
        focus: "Two-dimensional design principles including line, shape, color, value, form, texture, and space"
      },
      {
        name: "3-D Art and Design", 
        description: "Students work in figurative or nonfigurative sculpture, architectural models, metal work, ceramics, fiber arts, glass work, jewelry, or mixed media",
        focus: "Three-dimensional design principles including form, volume, mass, texture, and space"
      },
      {
        name: "Drawing",
        description: "Students work in drawing, painting, printmaking, or mixed media that demonstrates drawing skills",
        focus: "Mark-making, line quality, light and shade, composition, surface manipulation, and illusion of depth"
      }
    ],
    sustainedInvestigation: {
      description: "A body of related works that demonstrates sustained investigation of a particular artistic concern",
      components: [
        "Written evidence of sustained investigation",
        "15 digital images of works created during the investigation",
        "Written commentary for each image explaining the artistic decisions"
      ],
      requirements: [
        "Clearly identify the inquiry that guided the investigation",
        "Demonstrate understanding through practice, experimentation, and revision",
        "Show evidence of synthesis of materials, processes, and ideas",
        "Articulate artistic concerns and how they evolved"
      ]
    },
    selectedWorks: {
      description: "A selection of works that best demonstrate technical skill and understanding of design principles",
      components: [
        "5 works that demonstrate technical competence",
        "Quality craftsmanship and effective use of materials",
        "Strong understanding of visual design principles"
      ],
      evaluation: [
        "Technical skill in chosen medium",
        "Understanding of design principles",
        "Quality of work and attention to craft",
        "Effective use of materials and processes"
      ]
    },
    keySkills: [
      "Artistic Investigation: Develop sustained inquiry through art making",
      "Experimentation: Explore materials, processes, and ideas",
      "Revision: Refine work based on evaluation and reflection",
      "Synthesis: Combine materials, processes, and ideas meaningfully",
      "Reflection: Articulate artistic decisions and learning",
      "Technical Skills: Demonstrate competence in chosen media"
    ],
    studyTips: [
      "Start your sustained investigation early and develop it consistently",
      "Document your process thoroughly with photos and written reflection",
      "Experiment with different materials and techniques",
      "Seek feedback from teachers and peers regularly",
      "Keep a visual journal to track ideas and development",
      "Study contemporary and historical artists for inspiration",
      "Focus on developing your personal artistic voice",
      "Practice technical skills in your chosen medium regularly",
      "Revise work based on critique and self-evaluation",
      "Organize your portfolio thoughtfully to show growth"
    ],
    portfolioGuidelines: [
      "Sustained Investigation should show clear artistic growth",
      "Include a variety of approaches within your investigation",
      "Selected Works should represent your best technical work",
      "Written commentary should be specific and reflective",
      "Images should be high quality and properly formatted",
      "Show evidence of risk-taking and experimentation",
      "Demonstrate understanding of your chosen medium",
      "Include works that show problem-solving abilities",
      "Ensure all work is original and created during the course",
      "Follow all submission guidelines and deadlines carefully"
    ],
    assessmentCriteria: {
      sustainedInvestigation: [
        "Inquiry: How clearly is the sustained investigation identified?",
        "Practice/Experimentation/Revision: How clearly does the work show evidence of practice, experimentation, and revision?",
        "Materials/Processes/Ideas: How well does the work show synthesis of materials, processes, and ideas?"
      ],
      selectedWorks: [
        "Technical Skill: How well does the work show technical competence?",
        "Design: How well does the work show understanding of 2-D/3-D design principles?"
      ]
    },
    commonMistakes: [
      "Not starting the sustained investigation early enough",
      "Choosing an investigation that's too broad or too narrow",
      "Not documenting the process adequately",
      "Focusing only on finished products rather than process",
      "Not revising work based on feedback",
      "Submitting work that doesn't fit the portfolio requirements",
      "Poor quality photography or digital images",
      "Inadequate written commentary",
      "Not showing enough variety within the investigation",
      "Waiting until the last minute to complete the portfolio"
    ]
  },
  ...
  "spanishLanguage": {
    ...
    description: "Develop proficiency in Spanish language and understanding of Spanish-speaking cultures through study of themes, literature, arts, and contemporary issues.",
    examFormat: {
      duration: "Approximately 3 hours",
      sections: [
        { name: "Multiple Choice", questions: 65, time: "95 minutes", weight: "50%" },
        { name: "Free Response", questions: 4, time: "85 minutes", weight: "50%" }
      ]
    },
    bigIdeas: [
      "Communication: Students communicate in Spanish in interpersonal, interpretive, and presentational modes",
      "Cultures: Students gain knowledge and understanding of Spanish-speaking cultures",
      "Connections: Students connect with other disciplines and acquire information through Spanish",
      "Comparisons: Students develop insight into language and culture",
      "Communities: Students participate in Spanish-speaking communities at home and around the world"
    ],
    units: [
      {
        name: "Unit 1: Families and Communities",
        weight: "16-17%",
        topics: [
        ...
        keyConcepts: [
          "La estructura familiar tradicional y moderna",
          "Las celebraciones y tradiciones culturales",
        ...
        essentialKnowledge: [
          "Family structures vary across Spanish-speaking cultures",
          "Community traditions reflect cultural values and history",
          "Education plays different roles in various societies",
          "Intergenerational relationships shape family dynamics",
          "Community service strengthens social bonds"
        ]
      },
      {
        name: "Unit 2: Science and Technology",
        weight: "16-17%",
        topics: [
        ...
        keyConcepts: [
          "El acceso a la tecnología y la brecha digital",
          "Los efectos de la tecnología en la sociedad",
          "Los fenómenos naturales y el cambio climático",
          "Los avances médicos y la salud pública",
          "La protección del medio ambiente",
          "Las innovaciones científicas y tecnológicas"
        ],
        essentialKnowledge: [
          "Technology access varies globally and affects social equality",
          "Scientific advances transform healthcare and society",
          "Environmental challenges require international cooperation",
          "Natural phenomena impact human communities",
          "Innovation drives economic and social development"
        ]
      },
      {
        name: "Unit 3: Beauty and Aesthetics",
        weight: "16-17%",
        topics: [
        ...
        keyConcepts: [
          "Las definiciones de la belleza en diferentes culturas",
        ...
        essentialKnowledge: [
          "Beauty standards reflect cultural values and change over time",
          "Architecture embodies cultural identity and values",
          "Music serves as cultural expression and preservation",
          "Visual arts communicate social and political messages",
          "Literature preserves and transmits cultural heritage"
        ]
      },
      {
        name: "Unit 4: Contemporary Life",
        weight: "16-17%",
        topics: [
        ...
        keyConcepts: [
          "El entretenimiento y el tiempo libre",
          "El turismo y los viajes culturales",
          "El estilo de vida y las redes sociales",
          "Las relaciones personales y las costumbres sociales",
          "Los ritos de paso",
          "La salud y el bienestar"
        ],
        essentialKnowledge: [
          "Leisure activities reflect cultural priorities and values",
          "Tourism impacts local economies and cultures",
          "Social media transforms interpersonal relationships",
          "Rites of passage mark important life transitions",
          "Well-being concepts vary across cultures"
        ]
      },
      {
        name: "Unit 5: Global Challenges",
        weight: "16-17%",
        topics: [
          "Economic issues",
        ...
        keyConcepts: [
          ...
          "La paz y los conflictos internacionales",
          "La conciencia social y cívica",
          "La inmigración y la migración"
        ],
        essentialKnowledge: [
          "Economic inequality affects global development",
          "Environmental challenges require international solutions",
          "Human rights are universal but implementation varies",
          "Migration patterns reflect economic and social factors",
          "Social conscience drives activism and change"
        ]
      },
      {
        name: "Unit 6: Personal and Public Identities",
        weight: "16-17%",
        topics: [
          "Beliefs and values",
          "National and ethnic identities",
          "Personal interests and self-image",
        ...
        keyConcepts: [
          ...
          "Los intereses personales y la autoimagen",
          "Los héroes y las figuras históricas",
          "Los roles de género y las relaciones",
          "El multiculturalismo y la asimilación"
        ],
        essentialKnowledge: [
          "Personal identity is shaped by multiple factors",
          "National identity reflects shared history and values",
          "Historical figures influence cultural identity",
          "Gender roles vary across cultures and evolve over time",
          "Multiculturalism creates both opportunities and challenges"
        ]
      }
    ],
    keySkills: [
      "Interpretive Communication: Understand written and audio texts",
      "Interpersonal Communication: Engage in conversations and exchange information",
      "Presentational Communication: Present information to an audience",
      "Cultural Comparison: Compare cultural practices, products, and perspectives",
      "Language Comparison: Compare Spanish with native language structures"
    ],
    studyTips: [
      "Immerse yourself daily in Spanish through music, videos, and news",
      "Practice speaking regularly with native speakers or language partners",
      "Read Spanish literature and contemporary articles on exam themes",
      "Watch Spanish-language films and TV shows with Spanish subtitles",
      "Practice writing essays using advanced vocabulary and grammar structures",
      "Study cultural context behind language use and expressions",
      "Master subjunctive mood usage in complex sentences",
      "Practice interpretive tasks with authentic Spanish materials",
      "Develop presentation skills for formal speaking tasks",
      "Learn about current events in Spanish-speaking countries"
    ],
    commonTopics: [
      "Family traditions and contemporary family structures",
      "Technology's impact on Spanish-speaking societies",
      "Hispanic art, music, and literature",
      "Contemporary social issues and lifestyle changes",
      "Environmental challenges in Latin America and Spain",
      "Immigration and identity in Hispanic communities",
      "Educational systems in Spanish-speaking countries",
      "Healthcare and social services",
      "Economic development and globalization",
      "Cultural celebrations and religious practices"
    ]
  },

  "frenchLanguage": {
    name: "AP French Language and Culture",
    description: "Develop proficiency in French language and understanding of Francophone cultures through study of themes, literature, arts, and contemporary issues.",
    examFormat: {
      duration: "Approximately 3 hours",
      sections: [
        { name: "Multiple Choice", questions: 65, time: "95 minutes", weight: "50%" },
    ...
    bigIdeas: [
      "Communication: Students communicate in French in interpersonal, interpretive, and presentational modes",
      "Cultures: Students gain knowledge and understanding of Francophone cultures",
      "Connections: Students connect with other disciplines and acquire information through French",
      "Comparisons: Students develop insight into language and culture",
      "Communities: Students participate in French-speaking communities at home and around the world"
    ],
    units: [
      {
        name: "Unit 1: Families and Communities",
        ...
        keyConcepts: [
          "La structure familiale traditionnelle et moderne",
          "Les célébrations et traditions culturelles",
        ...
        essentialKnowledge: [
          "Family structures vary across Francophone cultures",
          "Community traditions reflect cultural values and history",
          "Education systems differ between French-speaking countries",
          "Intergenerational relationships shape family dynamics",
          "Community service strengthens social bonds"
        ]
      },
      {
        ...
        keyConcepts: [
          "L'accès à la technologie et la fracture numérique",
          "Les effets de la technologie sur la société",
          "Les phénomènes naturels et le changement climatique",
          "Les progrès médicaux et la santé publique",
      ...
      },
      {
        ...
        keyConcepts: [
          "Les définitions de la beauté dans différentes cultures",
          "L'architecture comme expression culturelle",
          "La musique comme identité culturelle",
          "La mode et le design contemporain",
          "Les arts visuels et du spectacle",
          "La littérature comme patrimoine culturel"
        ],
        essentialKnowledge: [
          "Beauty standards reflect cultural values and change over time",
          "French architecture embodies cultural identity and values",
          "Music serves as cultural expression and preservation",
          "Visual arts communicate social and political messages",
          "Literature preserves and transmits cultural heritage"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Le tourisme et les voyages culturels",
          "Le style de vie et les réseaux sociaux",
          "Les relations personnelles et les coutumes sociales",
      ...
      },
      {
        ...
        keyConcepts: [
          "Les problèmes économiques mondiaux",
          "Les défis environnementaux mondiaux",
          "Les droits de l'homme universels",
          "La paix et les conflits internationaux",
          "La conscience sociale et civique",
      ...
      },
      {
        ...
        keyConcepts: [
          ...
          "Les identités nationales et ethniques",
          "Les intérêts personnels et l'image de soi",
          "Les héros et les figures historiques",
          "Les rôles de genre et les relations",
          "Le multiculturalisme et l'assimilation"
        ],
        essentialKnowledge: [
          "Personal identity is shaped by multiple factors",
          "French national identity reflects shared history and values",
          "Historical figures influence cultural identity",
          "Gender roles vary across cultures and evolve over time",
          "Multiculturalism creates both opportunities and challenges"
        ]
    ...
    keySkills: [
      ...
      "Presentational Communication: Present information to an audience",
      "Cultural Comparison: Compare cultural practices, products, and perspectives",
      "Language Comparison: Compare French with native language structures"
    ],
    studyTips: [
      "Immerse yourself daily in French through music, videos, and news",
      "Practice speaking regularly with native speakers or language partners",
      "Read French literature and contemporary articles on exam themes",
      "Watch French-language films and TV shows with French subtitles",
      "Practice writing essays using advanced vocabulary and grammar structures",
      "Study cultural context behind language use and expressions",
      "Master subjunctive mood usage in complex sentences",
      "Practice interpretive tasks with authentic French materials",
      "Develop presentation skills for formal speaking tasks",
      "Learn about current events in French-speaking countries"
    ],
    commonTopics: [
      "Family traditions and contemporary family structures in France",
      "Technology's impact on Francophone societies",
      "French art, music, and literature",
      "Contemporary social issues and lifestyle changes",
      "Environmental challenges in French-speaking regions",
      "Immigration and identity in Francophone communities",
      "Educational systems in French-speaking countries",
      "Healthcare and social services",
      "Economic development and globalization",
      "Cultural celebrations and religious practices"
    ]
  ...
  "germanLanguage": {
    ...
    description: "Develop proficiency in German language and understanding of German-speaking cultures through study of themes, literature, arts, and contemporary issues.",
    examFormat: {
      duration: "Approximately 3 hours",
      sections: [
        { name: "Multiple Choice", questions: 65, time: "95 minutes", weight: "50%" },
    ...
    bigIdeas: [
      "Communication: Students communicate in German in interpersonal, interpretive, and presentational modes",
      "Cultures: Students gain knowledge and understanding of German-speaking cultures",
      "Connections: Students connect with other disciplines and acquire information through German",
      "Comparisons: Students develop insight into language and culture",
      "Communities: Students participate in German-speaking communities at home and around the world"
    ],
    units: [
      {
        name: "Unit 1: Families and Communities",
        ...
        keyConcepts: [
          "Die traditionelle und moderne Familienstruktur",
          "Kulturelle Feiern und Traditionen",
        ...
        essentialKnowledge: [
          "Family structures vary across German-speaking cultures",
          "Community traditions reflect cultural values and history",
          "Education systems emphasize academic achievement",
          "Intergenerational relationships shape family dynamics",
          "Community service strengthens social bonds"
        ]
      },
      {
        ...
        keyConcepts: [
          "Der Zugang zur Technologie und die digitale Kluft",
          "Die Auswirkungen der Technologie auf die Gesellschaft",
          "Naturphänomene und der Klimawandel",
          "Medizinische Fortschritte und öffentliche Gesundheit",
          "Umweltschutz",
          "Wissenschaftliche und technologische Innovationen"
        ],
        essentialKnowledge: [
          "Germany is a leader in technological innovation",
          "Environmental protection is a cultural priority",
          "Healthcare systems reflect social values",
          "Scientific research drives economic development",
          "Technology shapes social interactions"
        ]
      }
    ],
    keySkills: [
      ...
      "Presentational Communication: Present information to an audience",
      "Cultural Comparison: Compare cultural practices, products, and perspectives",
      "Language Comparison: Compare German with native language structures"
    ],
    studyTips: [
      "Practice German case system thoroughly",
      "Immerse yourself in German media and culture daily",
      "Master complex sentence structures and word order",
      "Study German history and cultural context",
      "Practice formal and informal communication styles"
    ],
    commonTopics: [
      "German reunification and modern identity",
      "Environmental sustainability initiatives",
      "Educational systems and apprenticeship programs",
  ...
  "italianLanguage": {
    ...
    description: "Develop proficiency in Italian language and understanding of Italian culture through study of themes, literature, arts, and contemporary issues.",
    examFormat: {
      duration: "Approximately 3 hours",
      sections: [
        { name: "Multiple Choice", questions: 65, time: "95 minutes", weight: "50%" },
    ...
    bigIdeas: [
      "Communication: Students communicate in Italian in interpersonal, interpretive, and presentational modes",
      "Cultures: Students gain knowledge and understanding of Italian culture",
      "Connections: Students connect with other disciplines and acquire information through Italian",
      "Comparisons: Students develop insight into language and culture",
      "Communities: Students participate in Italian-speaking communities at home and around the world"
    ],
    units: [
      {
        name: "Unit 1: Families and Communities",
        ...
        keyConcepts: [
          "La struttura familiare tradizionale e moderna",
          "Le celebrazioni e tradizioni culturali",
          "L'importanza dell'istruzione",
          "Le relazioni intergenerazionali",
          "Il servizio comunitario",
          "I valori familiari e sociali"
        ],
        essentialKnowledge: [
          "Family remains central to Italian society",
          "Regional traditions vary throughout Italy",
          "Education emphasizes cultural heritage",
          "Extended family relationships are important",
          "Community festivals strengthen social bonds"
        ]
      },
      {
        name: "Unit 2: Science and Technology",
        ...
        keyConcepts: [
          ...
          "I fenomeni naturali e il cambiamento climatico",
          "I progressi medici e la sanità pubblica",
          "La protezione dell'ambiente",
          "Le innovazioni scientifiche e tecnologiche"
        ],
        essentialKnowledge: [
          "Italy balances tradition with technological advancement",
          "Environmental challenges affect Mediterranean regions",
          "Healthcare systems serve diverse populations",
          "Innovation occurs in traditional and modern industries",
          "Technology transforms cultural preservation"
        ]
      }
    ],
    keySkills: [
      ...
      "Presentational Communication: Present information to an audience",
      "Cultural Comparison: Compare cultural practices, products, and perspectives",
      "Language Comparison: Compare Italian with native language structures"
    ],
    studyTips: [
      "Study Italian art and cultural history extensively",
      "Practice pronunciation and intonation patterns",
      "Learn regional variations and dialects",
      "Immerse yourself in Italian cinema and literature",
      "Master complex verb tenses and subjunctive mood"
    ],
    commonTopics: [
      ...
      "Contemporary Italian cinema and media"
    ]
  },

  "chineseLanguage": {
    name: "AP Chinese Language and Culture",
    description: "Develop proficiency in Chinese language and understanding of Chinese culture through study of themes, literature, arts, and contemporary issues.",
    examFormat: {
      duration: "Approximately 2 hours 15 minutes",
      sections: [
        { name: "Multiple Choice", questions: 70, time: "70 minutes", weight: "50%" },
        { name: "Free Response", questions: 4, time: "65 minutes", weight: "50%" }
      ]
    },
    bigIdeas: [
      "Communication: Students communicate in Chinese in interpersonal, interpretive, and presentational modes",
      "Cultures: Students gain knowledge and understanding of Chinese culture",
      "Connections: Students connect with other disciplines and acquire information through Chinese",
      "Comparisons: Students develop insight into language and culture",
      "Communities: Students participate in Chinese-speaking communities at home and around the world"
    ],
    units: [
      {
        name: "Unit 1: Families and Communities",
        ...
        keyConcepts: [
          "传统和现代家庭结构 (Traditional and modern family structure)",
          "文化庆祝活动和传统 (Cultural celebrations and traditions)",
          "教育的重要性 (Importance of education)",
          "代际关系 (Intergenerational relationships)",
          "社区服务 (Community service)",
          "家庭和社会价值观 (Family and social values)"
        ],
        essentialKnowledge: [
          "Filial piety remains central to Chinese family values",
          "Traditional festivals reflect cultural heritage",
          "Education is highly valued in Chinese society",
          "Extended family relationships are important",
          "Community harmony is a social priority"
        ]
      },
      {
        name: "Unit 2: Science and Technology",
        ...
        keyConcepts: [
          "技术获取和数字鸿沟 (Technology access and digital divide)",
          "技术对社会的影响 (Effects of technology on society)",
          "自然现象和气候变化 (Natural phenomena and climate change)",
          "医学进步和公共健康 (Medical advances and public health)",
          "环境保护 (Environmental protection)",
          "科技创新 (Scientific and technological innovation)"
        ],
        essentialKnowledge: [
          "China is a leader in technological advancement",
          "Traditional medicine coexists with modern healthcare",
          "Environmental challenges require urgent attention",
    ...
    keySkills: [
      ...
      "Presentational Communication: Present information to an audience",
      "Cultural Comparison: Compare cultural practices, products, and perspectives",
      "Language Comparison: Compare Chinese with native language structures"
    ],
    studyTips: [
      "Practice character recognition and writing daily",
      "Master tone system for proper pronunciation",
      "Study Chinese history and cultural context",
      "Practice formal and informal communication styles",
      "Learn both simplified and traditional characters"
    ],
    commonTopics: [
      "Traditional festivals and modern celebrations",
      "Educational systems and competition",
  ...
  "japaneseLanguage": {
    ...
    description: "Develop proficiency in Japanese language and understanding of Japanese culture through study of themes, literature, arts, and contemporary issues.",
    examFormat: {
      duration: "Approximately 2 hours 15 minutes",
      sections: [
        { name: "Multiple Choice", questions: 70, time: "70 minutes", weight: "50%" },
    ...
    bigIdeas: [
      "Communication: Students communicate in Japanese in interpersonal, interpretive, and presentational modes",
      "Cultures: Students gain knowledge and understanding of Japanese culture",
      "Connections: Students connect with other disciplines and acquire information through Japanese",
      "Comparisons: Students develop insight into language and culture",
      "Communities: Students participate in Japanese-speaking communities at home and around the world"
    ],
    units: [
      {
        name: "Unit 1: Families and Communities",
        ...
        keyConcepts: [
          "伝統的で現代的な家族構造 (Traditional and modern family structure)",
          "文化的祝祭と伝統 (Cultural celebrations and traditions)",
          "教育の重要性 (Importance of education)",
          "世代間関係 (Intergenerational relationships)",
          "地域奉仕 (Community service)",
          "家族と社会の価値観 (Family and social values)"
        ],
        essentialKnowledge: [
          "Respect and hierarchy are fundamental to Japanese society",
          "Traditional festivals preserve cultural heritage",
          "Education emphasizes group harmony and achievement",
          "Family obligations shape individual choices",
      ...
      },
      {
        ...
        keyConcepts: [
          "技術へのアクセスとデジタル格差 (Technology access and digital divide)",
          "技術が社会に与える影響 (Effects of technology on society)",
          "自然現象と気候変動 (Natural phenomena and climate change)",
          "医学の進歩と公衆衛生 (Medical advances and public health)",
          "環境保護 (Environmental protection)",
          "科学技術革新 (Scientific and technological innovation)"
        ],
        essentialKnowledge: [
          "Japan leads in technological innovation",
          "Natural disasters influence cultural perspectives",
          "Healthcare combines tradition and modern medicine",
          "Environmental consciousness drives policy",
          "Technology shapes social interactions"
        ]
      }
    ],
    keySkills: [
      ...
      "Presentational Communication: Present information to an audience",
      "Cultural Comparison: Compare cultural practices, products, and perspectives",
      "Language Comparison: Compare Japanese with native language structures"
    ],
    studyTips: [
      "Master hiragana, katakana, and basic kanji",
      "Practice proper levels of politeness (keigo)",
      "Study Japanese history and cultural context",
      "Learn about traditional and contemporary culture",
      "Practice reading various text types"
    ],
    commonTopics: [
      "Traditional arts and modern culture",
      "Educational systems and social pressure",
  ...
  "latin": {
    name: "AP Latin",
    description: "Develop proficiency in reading and understanding Latin literature while exploring the cultural and historical contexts of ancient Rome.",
    examFormat: {
      duration: "3 hours",
      sections: [
        { name: "Multiple Choice", questions: 50, time: "90 minutes", weight: "50%" },
    ...
    bigIdeas: [
      "Language and Text: Latin texts reveal linguistic patterns and literary techniques",
      "Cultural Context: Roman culture, history, and values shape literary expression",
      "Interpretation: Multiple perspectives enhance understanding of Latin literature",
      "Connections: Latin literature connects to modern culture and literature"
    ],
    units: [
      {
        name: "Unit 1: Caesar's Gallic Wars",
        weight: "50%",
        topics: [
          "Book 1 selections",
          "Book 4 selections", 
          ...
          "Cultural descriptions of Gallic peoples",
          "Roman political and military organization"
        ],
        keyConcepts: [
          "Caesar's prose style and narrative techniques",
          "Military terminology and concepts",
          "Roman attitudes toward foreign peoples",
          "Political propaganda in historical writing",
          "Geographic and ethnographic descriptions",
          "Leadership and command decisions"
        ],
        essentialKnowledge: [
          "Caesar wrote to promote his political career",
          "The Gallic Wars established Caesar's military reputation",
          "Roman expansion involved cultural conflict",
          "Military success translated to political power",
          "Historical writing served political purposes"
        ]
      },
      {
        name: "Unit 2: Vergil's Aeneid",
        weight: "50%",
        topics: [
          "Book 1 selections",
          "Book 2 selections",
          "Book 4 selections", 
          "Book 6 selections",
          "Epic conventions and heroic themes",
          "Divine intervention and fate",
          "Foundation mythology and Roman destiny"
        ],
        keyConcepts: [
          "Epic poetry conventions and meter",
        ...
        essentialKnowledge: [
          "The Aeneid legitimizes Roman imperial power",
          "Aeneas embodies Roman virtues and values",
          "Epic poetry serves national and cultural purposes",
          "Divine will guides human destiny",
          "Literature preserves and promotes cultural values"
        ]
      }
    ],
    keySkills: [
      "Reading Comprehension: Understand Latin texts accurately",
      "Translation: Render Latin into idiomatic English",
      "Literary Analysis: Analyze literary techniques and themes",
      "Cultural Analysis: Understand texts within historical context",
      "Comparison: Connect Latin literature to other works and cultures"
    ],
    studyTips: [
      "Master Latin grammar and syntax thoroughly",
      "Read extensively in both prose and poetry",
      "Study Roman history and cultural context",
      "Practice sight-reading unfamiliar passages",
      "Analyze literary devices and their effects",
      "Compare Roman values with contemporary values",
      "Use commentaries and scholarly resources",
      "Practice timed translation exercises",
      "Study meter and poetic techniques for Vergil",
      "Connect Latin literature to modern works"
    ],
    commonTopics: [
      "Roman military organization and tactics",
      "Political propaganda in historical writing",
      "Cultural conflict and Roman expansion",
      "Epic heroism and character development",
      "Divine intervention and human destiny",
      "Foundation myths and national identity",
      "Literary techniques in prose and poetry",
      "Roman values and social expectations",
      "Historical context of literary works",
      "Influence of Latin literature on later writers"
    ]
  },

  "comparativeGovernment": {
    name: "AP Comparative Government and Politics",
    description: "Compare the political systems of six countries: China, Iran, Mexico, Nigeria, Russia, and the United Kingdom.",
    bigIdeas: [
    ...
    units: [
      {
        ...
        essentialKnowledge: [
          "Political systems vary in sources of authority",
          "Constitutions establish governmental structures",
          "Federalism affects policy implementation",
          "Democratic institutions require citizen participation"
        ]
      },
      {
        ...
        essentialKnowledge: [
          "Executive power varies across systems",
          "Legislative effectiveness depends on structure",
          "Independent judiciary protects rights",
          "Bureaucracy implements policy decisions"
        ]
      },
      {
        ...
        keyConcepts: [
          ...
          "Party system competition",
          "Interest group influence"
        ],
        essentialKnowledge: [
          "Political culture shapes citizen behavior",
          "Electoral systems affect representation",
          "Civil society strengthens democracy",
          "Party systems vary in competitiveness"
        ]
      },
      {
        ...
        essentialKnowledge: [
          "Electoral systems shape party competition",
          "Campaign finance affects political equality",
          "Interest groups provide representation",
          "Social movements challenge existing policies"
        ]
      },
      {
        ...
        essentialKnowledge: [
          "Democratization faces multiple challenges",
          "Economic development affects political stability",
          "State capacity varies across countries",
          "Corruption undermines governance"
        ]
      }
    ],
    keySkills: [
      "Conceptual Analysis: Understand and apply political concepts",
      "Comparison: Compare political systems and processes",
      "Data Analysis: Interpret quantitative and qualitative data",
      "Source Analysis: Evaluate political documents and media",
      "Argumentation: Develop and support political arguments"
    ],
    studyTips: [
      "Master the six core countries: China, Iran, Mexico, Nigeria, Russia, UK",
      "Practice comparing political institutions across countries",
      "Understand how political culture shapes behavior",
      "Analyze current events through comparative lens",
      "Use data to support comparative arguments",
      "Study electoral systems and their effects",
      "Examine democratization processes",
      "Connect economic and political development"
    ],
    commonTopics: [
      "Presidential vs. parliamentary systems",
      "Federal vs. unitary government structures",
      "Electoral system effects on representation",
      "Political party development and competition",
      "Civil society and democratic participation",
      "Authoritarian control mechanisms",
      "Economic liberalization impacts",
  ...
  "spanishLiterature": {
    ...
    description: "Develop proficiency in Spanish by reading and analyzing literary texts from Spain, Latin America, and U.S. Hispanic/Latino literature.",
    bigIdeas: [
    ...
    units: [
      {
        name: "La época medieval",
        weight: "8-10%",
        topics: [
          "El Cantar de mío Cid (Anónimo)",
          "Romances (Anónimo)",
          "Medieval literary traditions",
          "Heroic epic conventions",
          "Oral tradition and performance"
        ],
        keyConcepts: [
          "Epic poetry characteristics",
          "Medieval Spanish society",
          "Honor and loyalty themes",
          "Oral literary tradition",
          "Christian-Muslim cultural interaction"
        ],
        essentialKnowledge: [
          "Medieval literature reflects feudal values",
          "Epic poetry celebrates heroic ideals",
          "Romances preserve folk traditions",
          "Literature serves moral and social purposes"
        ]
      },
      {
        name: "El siglo XVI",
        ...
        topics: [
          ...
          "Picaresque novel origins",
          "Petrarcan sonnet form"
        ],
        keyConcepts: [
          "Renaissance literary innovations",
        ...
        essentialKnowledge: [
          "Renaissance brings Italian influences",
          "Picaresque novel critiques society",
          "Poetry adopts classical forms",
          "Literature explores individual identity"
        ]
      },
      {
        name: "El siglo XVII",
        ...
        topics: [
          ...
          "Luis de Góngora poetry",
          "Francisco de Quevedo poetry",
          "Baroque literary style",
          "Golden Age theater"
        ],
        keyConcepts: [
          "Baroque complexity and artifice",
          "Reality vs. illusion",
        ...
        essentialKnowledge: [
          "Cervantes creates the modern novel",
          "Baroque style emphasizes complexity",
          "Literature questions reality and truth",
          "Poetry explores metaphysical themes"
        ]
      },
      {
        name: "La literatura romántica, realista y naturalista",
        weight: "12-15%",
        topics: [
          "José de Espronceda poetry",
          "Gustavo Adolfo Bécquer poetry and prose",
          "Benito Pérez Galdós novels",
          "Romantic individualism",
          "Realist social criticism"
        ],
        keyConcepts: [
          "Romantic emphasis on emotion",
          "Realist attention to social issues",
          "Individual vs. social constraints",
          "Literary nationalism",
          "Psychological character development"
        ],
        essentialKnowledge: [
          "Romanticism emphasizes subjective experience",
          "Realism depicts contemporary social issues",
          "Literature reflects national identity",
          "Writers critique social inequalities"
        ]
      },
      {
        name: "La Generación del 98 y el Modernismo",
        weight: "15-18%",
        topics: [
          "Antonio Machado poetry",
          "Juan Ramón Jiménez poetry",
          "Miguel de Unamuno essays and novels",
          "Crisis of national identity",
          "Modernist aesthetic innovations"
        ],
        keyConcepts: [
          "National soul-searching after 1898",
          "Modernist symbolic language",
          "Existential philosophical concerns",
          "Art for art's sake",
          "Spanish cultural regeneration"
        ],
        essentialKnowledge: [
          "Generation of '98 responds to national crisis",
          "Modernism prioritizes aesthetic beauty",
          "Writers explore existential questions",
          "Literature seeks Spanish cultural renewal"
        ]
      },
      {
        name: "Teatro y poesía del siglo XX",
        weight: "12-15%",
        topics: [
          "Federico García Lorca poetry and theater",
          "Carmen Laforet novels",
          "Civil War and post-war literature",
          "Avant-garde movements",
          "Women's voices in literature"
        ],
        keyConcepts: [
          "Avant-garde experimental techniques",
          "Civil War trauma and memory",
          "Gender roles and women's experiences",
          "Censorship and coded resistance",
          "Popular culture influences"
        ],
        essentialKnowledge: [
          "Civil War profoundly affects literature",
          "Avant-garde techniques transform expression",
          "Women writers challenge traditional roles",
          "Literature preserves suppressed memories"
        ]
      },
      {
        name: "El Boom latinoamericano",
        weight: "15-18%",
        topics: [
          ...
          "Magical realism",
          "Latin American identity themes"
        ],
        keyConcepts: [
          "Magical realism as narrative technique",
          "Labyrinthine literary structures",
          "Time and reality manipulation",
          "Latin American cultural identity",
          "Postcolonial literary expression"
        ],
        essentialKnowledge: [
          "Boom writers gain international recognition",
          "Magical realism blends reality and fantasy",
          "Literature explores Latin American identity",
          "Writers experiment with narrative form"
        ]
      },
      {
        name: "Escritores contemporáneos de Estados Unidos",
        weight: "8-12%",
        topics: [
          "Julia de Burgos poetry",
          "Sabine Ulibarrí short stories",
          "U.S. Hispanic/Latino experience",
          "Bilingual literary expression",
          "Immigration and identity themes"
        ],
        keyConcepts: [
          "Bicultural identity challenges",
          "Language choice and meaning",
          "Immigration experience",
          "Cultural preservation vs. assimilation",
          "Minority voice in literature"
        ],
        essentialKnowledge: [
          "U.S. Hispanic literature explores dual identity",
          "Writers navigate between cultures and languages",
          "Literature preserves cultural traditions",
          "Immigration shapes literary themes"
        ]
      }
    ],
    keySkills: [
      "Reading Comprehension: Understand literary texts in Spanish",
      "Literary Analysis: Analyze literary devices and techniques",
      "Cultural Knowledge: Understand historical and cultural contexts",
      "Comparison: Compare texts across periods and regions",
      "Written Communication: Write analytical essays in Spanish"
    ],
    studyTips: [
      "Read texts multiple times for deeper understanding",
      "Study historical and cultural contexts of each period",
      "Practice identifying literary devices and techniques",
      "Learn to compare texts across different eras",
      "Develop vocabulary for literary analysis",
      "Practice writing analytical essays in Spanish",
      "Connect literature to broader cultural movements",
      "Study biographical information about authors"
    ],
    commonTopics: [
      "Medieval epic poetry and romances",
      "Renaissance and Golden Age literature",
      "Baroque literary complexity",
      "Romantic and realist movements",
      "Generation of '98 and modernism",
      "20th-century poetry and theater",
      "Latin American Boom literature",
      "U.S. Hispanic/Latino literary voices",
      "Magical realism and experimental narrative",
  ...
  "studioArt2D": {
    ...
    description: "Develop mastery in 2-D design through a portfolio that demonstrates artistic investigation of materials, processes, and ideas.",
    bigIdeas: [
      "Visual Relationships",
      "Materials, Processes, and Ideas",
      "Making Through Practice, Experimentation, and Revision",
      "Presenting Ideas Through Portfolio Development"
    ],
    examFormat: {
      duration: "Portfolio Submission",
      sections: [
        ...
        },
        {
          ...
          questions: "15 works + written responses",
          time: "Year-long", 
          weight: "50%"
        }
      ]
    ...
    units: [
      {
        name: "Elements and Principles of 2-D Design",
        weight: "20-25%",
        topics: [
        ...
        keyConcepts: [
          "Visual elements as building blocks",
          "Principles organize visual elements",
          "Color relationships and interactions",
          "Compositional structure",
          "Visual hierarchy and focal points"
        ],
        essentialKnowledge: [
          "Elements of design create visual impact",
          "Principles of design organize compositions",
          "Color theory guides aesthetic choices",
          "Composition directs viewer attention"
        ]
      },
      {
        name: "Materials and Techniques",
        weight: "25-30%",
        topics: [
        ...
        keyConcepts: [
          "Media characteristics and possibilities",
          "Technique serves artistic intent",
          "Traditional and contemporary approaches",
          "Material exploration and experimentation",
          "Process documentation"
        ],
        essentialKnowledge: [
          "Different media offer unique possibilities",
          "Technique skills enable expression",
      ...
      },
      {
        ...
        weight: "30-35%",
        topics: [
          "Developing a central idea or theme",
        ...
        keyConcepts: [
          "Inquiry-based artistic investigation",
          "Coherent body of work development",
          "Growth through revision",
          "Conceptual depth and complexity",
          "Reflective practice"
        ],
        essentialKnowledge: [
          "Sustained investigation shows artistic growth",
          "Central inquiry guides exploration",
          "Revision strengthens artistic work",
          "Reflection deepens understanding"
        ]
      },
      {
        name: "Portfolio Development and Presentation",
        weight: "20-25%",
        topics: [
          "Work selection and curation",
        ...
        keyConcepts: [
          ...
          "Quality documentation importance",
          "Clear communication of ideas",
          "Professional standards",
          "Portfolio as artistic statement"
        ],
        essentialKnowledge: [
          "Portfolio represents artistic journey",
          "Documentation affects work perception",
          "Artist statements clarify intentions",
          "Presentation quality matters"
        ]
      }
    ],
    keySkills: [
      "Visual Problem-Solving: Develop creative solutions to design challenges",
      "Technical Proficiency: Master various 2-D media and techniques",
      "Conceptual Development: Explore ideas through sustained investigation",
      "Critical Analysis: Evaluate and refine artistic work",
      "Communication: Articulate artistic intent and process"
    ],
    studyTips: [
      "Experiment with various 2-D media and techniques",
      "Develop a strong sustained investigation theme",
      "Document your artistic process thoroughly",
      "Seek feedback and revise work regularly",
      "Study contemporary and historical 2-D artists",
      "Practice writing about your artistic process",
      "Build technical skills consistently",
      "Maintain a well-organized portfolio"
    ],
    commonTopics: [
      "Drawing fundamentals and advanced techniques",
      "Color theory and color mixing",
      "Composition and visual organization",
      "Printmaking methods and applications",
      "Digital art and design tools",
      "Mixed media and experimental approaches",
      "Sustained investigation development",
      "Portfolio presentation and curation",
      "Artist statement writing",
  ...
  "studioArt3D": {
    ...
    description: "Explore 3-D design through direct experience in a variety of sculptural approaches, materials, and methods.",
    bigIdeas: [
      "3-D Elements and Relationships",
      "Materials, Processes, and Ideas",
      "Making Through Practice, Experimentation, and Revision", 
      "Presenting Ideas Through Portfolio Development"
    ],
    ...
    units: [
      {
        name: "Elements and Principles of 3-D Design",
        weight: "20-25%",
        topics: [
          ...
          "Balance, movement, and rhythm in 3-D"
        ],
        keyConcepts: [
          "Three-dimensional spatial relationships",
          "Physical properties of materials",
          "Viewer interaction with 3-D forms",
          "Environmental and contextual considerations",
          "Structural integrity and design"
        ],
        essentialKnowledge: [
          "3-D design involves spatial relationships",
          "Materials have inherent properties and limitations",
          "Scale affects viewer perception and interaction",
          "Context influences meaning and impact"
        ]
      },
      {
        ...
        weight: "25-30%",
        topics: [
          "Subtractive processes (carving, cutting)",
          "Additive processes (building, joining)",
          "Clay and ceramic techniques",
          "Metal working and fabrication",
          "Found objects and assemblage"
        ],
        keyConcepts: [
          "Process determines form and meaning",
          "Material properties guide technique choice",
          "Traditional and contemporary approaches",
          "Safety considerations in 3-D work",
          "Sustainability in material use"
        ],
        essentialKnowledge: [
          "Different processes offer unique possibilities",
          "Material knowledge enables creative expression",
          "Process choices affect final outcomes",
          "Safety protocols ensure productive making"
        ]
      },
      {
        name: "Sculptural Approaches and Concepts",
        weight: "25-30%",
        topics: [
        ...
        keyConcepts: [
          "Sculpture as physical and conceptual experience",
          "Site and context relationships",
          "Time-based and interactive elements",
          "Social and political dimensions",
          "Historical and contemporary references"
        ],
        essentialKnowledge: [
          "Sculpture encompasses diverse approaches",
          "Context shapes meaning and reception",
          "Contemporary sculpture challenges boundaries",
          "Art can engage social and political issues"
        ]
      },
      {
        name: "Sustained Investigation in 3-D",
        weight: "20-25%",
        topics: [
          "Developing coherent 3-D investigation",
          "Material and process exploration",
          "Conceptual development through making",
          "Documentation of 3-D process",
          "Reflection and revision in 3-D work"
        ],
        keyConcepts: [
          "Inquiry-driven 3-D exploration",
          "Growth through material engagement",
          "Process documentation challenges",
          "Revision in three dimensions",
          "Coherent body of 3-D work"
        ],
        essentialKnowledge: [
          "Sustained investigation shows artistic growth",
          "3-D work requires different documentation",
          "Material exploration drives conceptual development",
          "Revision may involve complete reconstruction"
        ]
      }
    ],
    keySkills: [
      "3-D Problem-Solving: Address spatial and structural challenges",
      "Material Expertise: Master various 3-D materials and tools",
      "Spatial Awareness: Understand form and space relationships",
      "Process Documentation: Record 3-D making processes effectively",
      "Conceptual Development: Explore ideas through physical making"
    ],
    studyTips: [
      "Experiment with diverse 3-D materials and processes",
      "Study how form and space create meaning",
      "Document your work from multiple angles",
      "Understand material properties and limitations",
      "Explore both traditional and contemporary sculpture",
      "Consider how viewers interact with your work",
      "Develop technical skills in various media",
      "Connect 3-D concepts to contemporary art"
    ],
    commonTopics: [
      "Clay modeling and ceramic processes",
      "Subtractive sculpture techniques",
      "Additive construction methods",
      "Metal working and fabrication",
      "Found object assemblage",
      "Installation and site-specific approaches",
  ...
  "studioArtDrawing": {
    ...
    description: "Develop drawing skills and investigate drawing as both a foundation for art-making and as an art form itself.",
    bigIdeas: [
    ...
    units: [
      {
        ...
        keyConcepts: [
          "Line as fundamental drawing element",
          "Value creates form and depth",
          "Proportion and scale relationships",
          "Observational drawing skills",
          "Mark-making and expression"
        ],
        essentialKnowledge: [
          "Drawing fundamentals support all visual art",
          "Observation skills improve through practice",
          "Line quality conveys meaning and emotion",
          "Value relationships create dimensional illusion"
        ]
      },
      {
        name: "Drawing Media and Techniques",
        weight: "20-25%",
        topics: [
          "Graphite and charcoal techniques",
          "Pen and ink approaches",
          "Pastel and chalk methods",
          "Mixed media drawing",
          "Digital drawing tools"
        ],
        keyConcepts: [
          "Media characteristics and possibilities",
          "Technique serves artistic expression",
          "Traditional and contemporary approaches",
          "Media experimentation and innovation",
          "Tool selection for intended effects"
        ],
        essentialKnowledge: [
          "Different media offer unique qualities",
          "Technique mastery enables expression",
          "Experimentation leads to personal style",
          "Tools influence aesthetic outcomes"
        ]
      },
      {
        name: "Observational and Interpretive Drawing",
        weight: "25-30%",
        topics: [
          "Still life drawing",
          "Figure and portrait drawing",
          "Landscape and architectural drawing",
          "Interpretive and expressive approaches",
          "Drawing from imagination"
        ],
        keyConcepts: [
          "Observational accuracy and interpretation",
          "Gesture and structure in figure work",
          "Environmental and atmospheric effects",
          "Personal vision and style development",
          "Conceptual and abstract approaches"
        ],
        essentialKnowledge: [
          "Observation skills transfer across subjects",
          "Drawing captures both appearance and essence",
          "Personal interpretation distinguishes artwork",
          "Imagination expands drawing possibilities"
        ]
      },
      {
        name: "Sustained Investigation Through Drawing",
        weight: "20-25%",
        topics: [
          "Developing a drawing-based inquiry",
          "Series development and variation",
          "Process documentation in drawing",
          "Revision and refinement strategies",
          "Conceptual depth through drawing"
        ],
        keyConcepts: [
          "Drawing as investigation tool",
          "Visual research and exploration",
          "Series unity and development",
          "Process over product emphasis",
          "Reflective drawing practice"
        ],
        essentialKnowledge: [
          "Drawing facilitates visual thinking",
          "Series development shows artistic growth",
          "Process documentation reveals development",
          "Revision strengthens conceptual clarity"
        ]
      }
    ],
    keySkills: [
      "Observational Skills: Develop acute visual perception",
      "Technical Proficiency: Master various drawing media",
      "Compositional Understanding: Organize visual elements effectively", 
      "Expressive Mark-Making: Use drawing to convey ideas and emotions",
      "Process Documentation: Record and reflect on drawing development"
    ],
    studyTips: [
      "Practice drawing daily to build observational skills",
      "Experiment with various drawing media and techniques",
      "Study master drawings throughout art history",
      "Develop personal approaches to mark-making",
      "Document your drawing process and experiments",
      "Work from both observation and imagination",
      "Build sustained investigation around drawing themes",
      "Seek feedback and engage in critique"
    ],
    commonTopics: [
      "Contour and gesture drawing",
      "Value studies and rendering",
      "Perspective and spatial representation",
      "Figure drawing and anatomy",
      "Still life composition and rendering",
      "Landscape and environmental drawing",
      "Expressive and abstract drawing approaches",
      "Mixed media and experimental techniques",
      "Portfolio development and presentation",
      "Drawing as conceptual tool and finished art"
    ]
  },
};
...
export const generateCurriculumContext = (subject) => {
...
export const getAvailableSubjects = () => {
  return Object.keys(AP_CURRICULUM_COMPREHENSIVE);
};

// Get subject units
export const getSubjectUnits = (subject) => {
  const curriculum = getCurriculumData(subject);
...
export default AP_CURRICULUM_COMPREHENSIVE;
