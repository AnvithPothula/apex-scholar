  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-slate-100">
      {takingDiagnostic ? (
        ...
        <div className="max-w-4xl mx-auto px-6 py-8">
          {isGeneratingQuestions ? (
            <Card className="p-12 text-center">
              ...
              <h2 className="text-2xl font-bold text-slate-200 mb-4">Generating Diagnostic Questions</h2>
              <p className="text-slate-400">AI is creating personalized questions for {takingDiagnostic.name}...</p>
            </Card>
          ) : diagnosticResult ? (
            // Results Display
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                ...
                <Card className="p-6">
                  <h3 className="text-xl font-bold text-slate-200 mb-4">Topic Breakdown</h3>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-8">
                <Card className="p-6">
                  ...
                  {diagnosticResult.strengths.length > 0 ? (
                    ...
                    <p className="text-slate-400">Focus on building fundamental knowledge</p>
                  )}
                </Card>
                ...
                <Card className="p-6">
                  ...
                  {diagnosticResult.weaknesses.length > 0 ? (
                    ...
                    <p className="text-slate-400">Great job! No major weak areas identified</p>
                  )}
                </Card>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h1 className="text-2xl font-bold text-slate-100">{takingDiagnostic.name} Diagnostic</h1>
          ...
          <Card className="p-6 bg-gradient-to-r from-blue-600/20 to-purple-600/20 border-blue-500/30">
            <div className="grid md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-slate-200 mb-2">Adaptive Assessment</h3>
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-slate-200 mb-2">Detailed Analysis</h3>
                <p className="text-sm text-slate-400">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-slate-200 mb-2">Quick Results</h3>
                <p className="text-sm text-slate-400">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-slate-200 mb-2">Study Plan</h3>
                <p className="text-sm text-slate-400">
        ...
        >
          <Card className="p-6">
            <h2 className="text-xl font-bold text-slate-100 mb-6 text-center">How AI Diagnostics Work</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-slate-200 mb-2">Take Assessment</h3>
                <p className="text-sm text-slate-400">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-slate-200 mb-2">AI Analysis</h3>
                <p className="text-sm text-slate-400">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-slate-200 mb-2">Get Results</h3>
                <p className="text-sm text-slate-400">
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h2 className="text-xl font-bold text-slate-100 mb-4">Popular Diagnostics</h2>
          <div className="grid md:grid-cols-4 gap-4">
            {['AP Calculus AB', 'AP Biology', 'AP U.S. History', 'AP Chemistry'].map((subjectName) => {
              ...
              return (
                <Card key={key} className="p-4 hover:bg-slate-800/50 transition-colors cursor-pointer group"
                  ...
                  <h3 className="font-semibold text-slate-200 mb-2 group-hover:text-purple-400 transition-colors">
                    {subject.name}
                  </h3>
        ...
        >
          <h2 className="text-xl font-bold text-slate-100 mb-6">All Diagnostic Assessments</h2>
          ...
          {filteredSubjects.length === 0 && (
            <div className="text-center py-12">
              ...
              <h3 className="text-xl font-bold text-slate-300 mb-2">No diagnostics found</h3>
        ...
        <motion.div
          ...
          className="mt-12"
        >
          <Card className="p-8 bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-blue-500/30">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-slate-200 mb-2">Identify Knowledge Gaps</h3>
                <p className="text-sm text-slate-400">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-slate-200 mb-2">Track Progress</h3>
                <p className="text-sm text-slate-400">
              ...
              <div className="text-center">
                ...
                <h3 className="font-semibold text-slate-200 mb-2">Optimize Study Time</h3>
                <p className="text-sm text-slate-400">
