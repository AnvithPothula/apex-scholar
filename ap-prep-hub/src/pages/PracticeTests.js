...
Generate ${numQuestions} questions now:`;
    ...
    try {
      ...
      try {
        ...
        generatedText = await geminiService.generateContent(prompt, { timeoutMs: 45000, temperature: 0.7, maxTokens, usageCategory: 'practiceTest' });
        if (!generatedText) {
...
Provide a clear, educational response that helps the student understand why ${correctAnswerLetter}) ${correctAnswerText} is the correct answer. Keep your response under 300 words.`;
    ...
    try {
      const text = await geminiService.generateContent(prompt, { timeoutMs: 45000, temperature: 0.3, maxTokens: 600, usageCategory: 'practiceTest' });
